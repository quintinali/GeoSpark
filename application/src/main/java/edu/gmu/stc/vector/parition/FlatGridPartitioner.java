...
public class FlatGridPartitioner extends SpatialPartitioner {
    ...
    @Override
    public  Iterator<Tuple2<Integer, ShapeFileMeta>> placeObject(ShapeFileMeta spatialObject) throws Exception {
        ...
        Set<Tuple2<Integer, ShapeFileMeta>> result = new HashSet();
    ...
    public boolean equals(Object o) {
        ...
        final FlatGridPartitioner
            other = (FlatGridPartitioner) o;
